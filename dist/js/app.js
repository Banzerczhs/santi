...
/******/ 	var hotCurrentHash = "4fd4a703a0ffa290eb54"; // eslint-disable-line no-unused-vars
...
(0, _jquery2.default)(function () {
	...
	(0, _jquery2.default)('.star a').click(function () {
		try {
	...
	(0, _jquery2.default)('.naver').hover(function () {
		(0, _jquery2.default)('.hd-content').addClass('active');
		(0, _jquery2.default)(this).find('ul').show();
	}, function () {
		(0, _jquery2.default)('.hd-content').removeClass('active');
		(0, _jquery2.default)(this).find('ul').hide();
	});
	// // 导航

	(0, _jquery2.default)('.nav-mune').click(function () {
		(0, _jquery2.default)('.naver').slideToggle();
		(0, _jquery2.default)('.content').toggle();
		(0, _jquery2.default)('.footer').toggle();
	});
	// End xs Nav

	(0, _jquery2.default)('.search .icon').click(function () {
		(0, _jquery2.default)('.tel').toggleClass('search-active-tel');
		(0, _jquery2.default)('.search-btn .icon-box').toggleClass('search-active-box');
	});

	(0, _jquery2.default)('.tel').click(function () {
		(0, _jquery2.default)('.tel').removeClass('search-active-tel');
		(0, _jquery2.default)('.search-btn .icon-box').removeClass('search-active-box');
	});
	// search xs
	...
	var ad1 = new _swiper2.default('.swiper-container', {
		pagination: {
	...
	// Banner
	var productAd = new _swiper2.default('.swiper-container-product', {
		slidesPerView: 2,
		spaceBetween: 20,
		loop: true,
		autoplay: {
